        ...
        <section className="event-kit-layout">
          ...
          <aside className="create-questionnaire-panel event-kit-create">
            ...
            <form action={createDilettantesInteractiveAction.bind(null, eventId)} className="editor-form" noValidate>
              <div className="form-field"><label className="form-field__label" htmlFor="dilettantes-question">Питання про подію або героїв</label><textarea id="dilettantes-question" name="question" placeholder="Скільки кілометрів разом проїхали молодята?" /></div>
