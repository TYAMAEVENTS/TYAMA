export type PublicMediaItem = { item_type?: string; data?: Record<string, unknown> | null };
export function itemAuthorizesPublicMedia(item: PublicMediaItem | null, assetId: string) {
